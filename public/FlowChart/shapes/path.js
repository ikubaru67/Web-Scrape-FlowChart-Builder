...
export function path(canvas, pathData) {
	...
	const svgGrp = svgEl('g', `
		...
		<path data-key="path" class="path" d="M0 0" stroke="#ffffff" stroke-width="1.8" fill="none" style="pointer-events: none;" />
		...
		<g data-key="start">
			...
			<path class="path" d="M-7 7 l 7 -7 l -7 -7" stroke="#ffffff" stroke-width="1.8" fill="none" style="pointer-events: none;"></path>
		</g>
		<g data-key="end">
			<circle data-evt-index="1" class="path-end" r="10" stroke-width="0" fill="transparent" />
			<path class="path" d="M-7 7 l 7 -7 l -7 -7" stroke="#ffffff" stroke-width="1.8" fill="none" style="pointer-events: none;"></path>
